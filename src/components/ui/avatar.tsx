...
const Avatar = ({ ref, className, ...props }: React.ComponentPropsWithoutRef<typeof AvatarPrimitive.Root> & { ref?: unknown }) => (
  <AvatarPrimitive.Root
    ref={ref as unknown as React.RefObject<React.ElementRef<typeof AvatarPrimitive.Root> | null>}
    className={cn(
...
const AvatarImage = ({ ref, className, ...props }: React.ComponentPropsWithoutRef<typeof AvatarPrimitive.Image> & { ref?: React.RefObject<React.ElementRef<typeof AvatarPrimitive.Image> | null> }) => (
  <AvatarPrimitive.Image
    ref={ref as unknown as React.RefObject<React.ElementRef<typeof AvatarPrimitive.Image> | null>}
